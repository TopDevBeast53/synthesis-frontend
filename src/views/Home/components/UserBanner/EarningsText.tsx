...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and AURApool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and AURApool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from AURApool', data)
  }
