        ...
        return (
            <Page>
                <Flex justifyContent="center" style={{paddingBottom: '8px'}}>
                    <Text  fontSize="18px" bold>Connect Your Wallet...</Text>
                </Flex>
                        ...
                        <Flex style={{paddingTop: '4px'}} alignItems="center">
                            ...
                            <Button onClick={async () => {
                                ...
                                try {
                                    ...
                                    const message: string = e?.data?.message ? e?.data?.message : 'Please try again if you have not been referred before.';
                                    toastError('Error', message);
                                    setDisabled(false)
                                }
                            }} disabled={disabled || isBalanceLoading || pendingBalance === '0'}>
                                <Text bold color="black">Claim</Text>
                            </Button>
                        </Flex>
                    </Flex>
                    <Flex flexDirection="column" style={{paddingTop: '18px'}}>
