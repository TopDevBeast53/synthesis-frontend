  ...
  return [
    {
      ...
      description: [
        t(
          'In the Basic Sale, every user can commit a maximum of about 100 USD worth of CAKE. We calculate the maximum AURAamount about 30 minutes before each IFO. The Basic Sale has no participation fee.',
        ),
        t(
          'In the Unlimited Sale, there’s no limit to the amount of AURAyou can commit. However, there’s a fee for participation: see below.',
        ),
      ],
    },
    {
    ...
    },
    {
      ...
      description: [t('The AURAfrom the participation fee will be thrown into the weekly token burn.')],
    },
    {
      title: t('How can I get an achievement for participating in the IFO?'),
      description: [
        t('You need to contribute a minimum of about 10 USD worth of AURAto either sale.'),
        t(
