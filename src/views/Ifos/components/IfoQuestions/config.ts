...
const config = (t: ContextApi['t']) => {
    return [
        ...
        },
        {
            ...
            description: [t('The HELIXfrom the participation fee will be thrown into the weekly token burn.')],
        },
        {
            title: t('How can I get an achievement for participating in the IFO?'),
            description: [
                t('You need to contribute a minimum of about 10 USD worth of HELIXto either sale.'),
                t(
