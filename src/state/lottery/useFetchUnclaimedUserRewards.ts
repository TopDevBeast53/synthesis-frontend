...
export const useGetWinningTickets = () => {
    const fetchCakeRewardsForTickets = useFetchCakeRewardsForTickets()
    return useCallback(async (
...
const useFetchUnclaimedUserRewards = () => {
...
export default useFetchUnclaimedUserRewards
