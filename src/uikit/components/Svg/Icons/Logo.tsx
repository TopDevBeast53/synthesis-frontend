...
const Icon: React.FC<SvgProps> = (props) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="63" height="63" viewBox="0 0 63 63" fill="none" {...props}>
      ...
      <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_2_910"/>
      <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_2_910" result="shape"/>
      </filter>
      </defs>
    </svg>
  );
